...
export const RonaldoBrito_PUCRIO: Professor = {
    ...
    AbreviacaoInstituicao: 'PUC/RJ',
    Departamento: undefined,
    Curso: 'Programa de Pós-Graduação em História Social da Cultura',
    Cidade: 'Rio de Janeiro',
    Estado: 'Rio de Janeiro',
    Pais: 'Brasil',
    DataInicio: '1998',
...
export const FernandoCocchiarale_HistoriaDaArte_PUCRIO: Professor = {
    ...
    AbreviacaoInstituicao: 'PUC/RJ',
    Departamento: undefined,
    Curso: 'Especialização em História da Arte e Arquitetura do Brasil',
    Cidade: 'Rio de Janeiro',
    Estado: 'Rio de Janeiro',
    Pais: 'Brasil',
    DataInicio: '1983',
...
export const PauloVenancioFilho_UFRJ: Professor = {
    ...
    Instituicao: 'Universidade Federal do Rio de Janeiro',
    AbreviacaoInstituicao: 'UFRJ',
    Departamento: 'Departamento de História e Teoria da Arte da Escolas de Belas Artes',
    Curso: undefined,
    Cidade: 'Rio de Janeiro',
    Estado: 'Rio de Janeiro',
    Pais: 'Brasil',
    DataInicio: '1994', // TODO ??
    DataFim: '...',
};
...
export const IvanSerpa: Professor = {
    ...
    DataInicio: '1964',
    DataFim: undefined,
    //TODO maioria da pessoal do grupo frente foi aluno dele, maioria qum??
};
