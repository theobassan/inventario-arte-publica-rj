...
export const Ritmo_BrunoGiorgi: Obra = {
    ...
    Fatos: [
        ...
        new Fato(
            ...
            '08/1984',
            'Autores:ização',
            'Autores:izado pelo Depaertamento de Parques e Jardins para ser instalada em espaço público',
            [],
            'Rio de Janeiro',
        ),
    ],
