...
export const JoaoCaetano_FranciscoManuelChavesPinheiro: Obra = {
    ...
    DatasImportantes: [
        new Data('1860', 'data de inauguração - arte ambiente'),
        new Data('05/1891', 'data de inauguração - arte ambiente'),
    ],
    Promotor: undefined,
    Financiamento: undefined,
    Propriedade: 'Pública',
...
export const NossaSenhoradaImaculadaConceicao_GiuseppeNavone: Obra = {
    ...
    Peso: undefined,
    ValorObra: undefined,
    DataInauguracao: `1906`, // TODO data importante 1907??
    DatasImportantes: [
        new Data(`1907`, 'data de inauguração - arte ambiente'),
...
export const DelPrete_RobertoSa: Obra = {
    ...
    Eixo: undefined, //'Narratividade',
    Funcao: undefined, //'Referencial',
    Natureza: undefined, //'Cívica',
    Tipologia: 'Estátua',
    Temporalidade: 'Permanente',
    Execucao: true,
};
...
export const ComendadorPauloFPeixotoDaFonfeca_HonorioPecanha: Obra = {
    ...
    Material: `Bloco de granito com placa de bronze`, //TODO arte ambiente - bronze
    Base: undefined,
    MaterialBase: undefined,
    Zona: 'Sul',
    Bairro: 'Bairro Peixoto',
    ...
    DatasImportantes: [new Data(`12/1944`, 'data de inauguração')], // TODO arte ambiente - anos 50
    Altura: undefined,
    Largura: undefined,
    Profundidade: undefined,
    Peso: undefined,
...
export const IbrahimSued_MarcosAndreSales: Obra = {
    ...
    Zona: 'Sul',
    Bairro: 'Copacabana',
    Endereço: 'Avenida Atlantica, próximo ao Copacabana Palace',
    Latitude: `-22.967595`,
...
export const ClarisseIndiodoBrasil_HCunhaMelo_Copy: Obra = {
    ID: 582,
    Imagem: 'ClarisseIndiodoBrasil_HCunhaMelo.jpg',
    Autores: [artistas.HCunhaMelo],
    Titulo: `Clarisse Índio do Brasil`,
