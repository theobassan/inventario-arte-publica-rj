...
function CalcularMaiorAutor(): { nome: string; obras: Obra[] } {
    const autoresOrdenadasPorTotalObras = autores.filter((autor) => autor.nome !== 'Desconhecida').sort((a, b) => (a.obras.length < b.obras.length ? 1 : -1));

    return autoresOrdenadasPorTotalObras[0];
}

function MaiorAutor(): JSX.Element {
